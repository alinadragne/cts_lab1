...
public class Model3DFlyweight implements ModelFlyweigthInterface{
	...
	public void display(ScreenData data) {
		...
		System.out.println(String.format("%s at coordinates (%f,%f,%f) with color %s", this.name,data.getX(),
				data.getY(),data.getZ(),data.getColor()));
